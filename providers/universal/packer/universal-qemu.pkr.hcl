...
//  accelerator       = "kvm"
  ...
  ssh_username      = "root"
  ssh_private_key_file = "${var.tmp_dir}/id_rsa"
...
build {
  ...
  provisioner "shell" {
    ...
    script = "${locals.provider_dir}/packer/prepare.sh"
    # run command as root
  ...
  provisioner "ansible-local" {
    ...
    playbook_file = "${locals.provider_dir}/images/${var.image_name}/provision.yml"
    playbook_dir = "./roles"
    extra_arguments = [
